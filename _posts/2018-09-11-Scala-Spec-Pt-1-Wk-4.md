...
<embed src="{{site.baseurl}}/assets/docs/scala_specialization/Part1/Week4/Huffman_Coding_Scala.pdf" style="width:100%" height="500ex" />
...
{% endhighlight %}
{% endcapture %}
{% include widgets/toggle-field.html toggle-name="toggle-Huffman" button-text="Huffman" toggle-text=text-capture  footer="End of Huffman"%}
